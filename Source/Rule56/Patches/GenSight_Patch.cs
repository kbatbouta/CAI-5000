...
namespace CombatAI.Patches
{
	public static class GenSight_Patch
	{
		...
		[HarmonyPatch(typeof(GenSight), nameof(GenSight.LineOfSight), new[] { typeof(IntVec3), typeof(IntVec3), typeof(Map), typeof(CellRect), typeof(CellRect), typeof(Func<IntVec3, bool>) })]
