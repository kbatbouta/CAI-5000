...
namespace CombatAI
{
	public class Settings : ModSettings
	{
		...
		{
			base.ExposeData();
			Scribe_Deep.Look(ref SightSettings_FriendliesAndRaiders,
				$"CombatAI.SightSettings_FriendliesAndRaiders.{version}");
			...
			if (SightSettings_Wildlife == null) SightSettings_Wildlife = new SightPerformanceSettings(6, 10, 4);
			Scribe_Deep.Look(ref SightSettings_SettlementTurrets,
				$"CombatAI.SightSettings_SettlementTurrets.{version}");
